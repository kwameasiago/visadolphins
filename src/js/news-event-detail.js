    ...
    function render(p) {
        ...
        if (thumb) {
            if (thumb.media_type === 'image') {
                heroHtml = '<img src="' + thumb.media_path + '" alt="" class="news-detail__cover">';
                ...
                heroHtml = '<video src="' + thumb.media_path + '" controls class="news-detail__cover"></video>';
            }
        }
        ...
        if (otherMedia.length) {
            var items = otherMedia.map(function (m) {
                if (m.media_type === 'image') {
                    return '<div class="news-gallery__item"><img src="' + m.media_path + '" alt="" loading="lazy"></div>';
                    ...
                    return '<div class="news-gallery__item news-gallery__item--video"><video src="' + m.media_path + '" controls></video></div>';
                }
                return '';
            }).join('');
