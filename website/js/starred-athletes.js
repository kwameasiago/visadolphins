(function () {
    ...
    fetch(APP_CONFIG.API_BASE_URL + '/starred-athletes.php')
        ...
        .then(function (data) {
            ...
            grid.innerHTML = athletes.map(function (a) {
                var imgSrc = resolveUploadUrl(a.image_path) || 'https://images.unsplash.com/photo-1530549387789-4c1017266635?w=400&h=500&fit=crop&crop=face';
