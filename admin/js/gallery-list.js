(function () {
    ...
    function showSkeleton() {
        var html = '';
        for (var i = 0; i < 8; i++) {
            html += '<div class="admin-skeleton-card"><div class="admin-skeleton-card__image"></div><div class="admin-skeleton-card__body"><div class="admin-skeleton-line admin-skeleton-line--md"></div></div></div>';
        }
        grid.innerHTML = html;
        ...
        grid.innerHTML = items.map(function (item) {
            ...
            return '<div class="admin-gallery-card" data-id="' + item.public_id + '">' +
                '<div class="admin-gallery-card__image">' +
                    '<img src="' + resolveUploadUrl(item.image_path) + '" alt="" loading="lazy">' +
                    tagBadge +
                '</div>' +
                ...
                '<div class="admin-gallery-card__actions">' +
                    '<a href="/gallery-upload.html?id=' + item.public_id + '" class="btn btn-sm btn-outline">Edit</a>' +
