(function () {
    ...
    function renderGrid(posts) {
        ...
        grid.innerHTML = posts.map(function (p) {
            ...
            if (p.thumb_type === 'image' && p.thumb_path) {
                thumbHtml = '<img src="' + resolveUploadUrl(p.thumb_path) + '" alt="">';
            ...
            return '<div class="admin-athlete-card" data-id="' + p.public_id + '">' +
                ...
                '<div class="admin-athlete-card__actions">' +
                    ...
                    '<a href="/news-event-edit.html?id=' + p.public_id + '" class="btn btn-sm btn-outline">Edit</a>' +
    ...
    async function toggleStar(publicId, newStar) {
        try {
            ...
            if (getRes.status === 401) { window.location.href = '/login.html'; return; }
