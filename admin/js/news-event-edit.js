    ...
    function renderExistingMedia() {
        ...
        existingMedia.forEach(function (m) {
            ...
            if (m.media_type === 'image') {
                previewHtml = '<img src="' + resolveUploadUrl(m.media_path) + '" alt="">';
                ...
                previewHtml = '<video src="' + resolveUploadUrl(m.media_path) + '" muted></video>';
            }
    ...
    form.addEventListener('submit', async function (e) {
        ...
        try {
            ...
            if (!publicId && data.public_id) {
                ...
                window.location.href = '/news-event-edit.html?id=' + data.public_id;
            } else {
